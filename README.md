...
```typescript
{
  ...
  password: string; // Required, 8-128 chars, complex pattern
}
```
...
```typescript
{
  email: string; // Required, trimmed
  code: string; // Required, trimmed
  newPassword: string; // Required, 8-128 chars, complex pattern
}
```
...
```typescript
{
  telegram_id: string; // Required, trimmed
  code: string; // Required, trimmed
}
```
